...
public class SistemaAmigoTest {
    ...
    void testEnviarMensagemParaAlguem() {
        ...
        assertEquals("texto", mensagensAchadas.get(1).getTexto());
    }

    @Test
    void testPesquisaMensagensAnonimas() {
        assertTrue(sistema.pesquisaTodasAsMensagens().isEmpty());
        sistema.enviarMensagemParaAlguem("texto 1", "jose@dcx.ufpb.br", "maria@dcx.ufpb.br", true);
        assertTrue(sistema.pesquisaMensagensAnonimas().isEmpty());
        sistema.enviarMensagemParaAlguem("texto 2", "jose@dcx.ufpb.br", "maria@dcx.ufpb.br", false);
