...
public class SistemaAmigoTest {
    ...
    void testPesquisaAmigoEConfiguraAmigoSecretoDe() {
        assertThrows(AmigoInexistenteException.class,
                ()-> sistema.pesquisaAmigoSecreto("jose@dcx.ufpb.br"));
        try {
            ...
            assertEquals("maria@dcx.ufpb.br", sistema.pesquisaAmigoSecreto("jose@dcx.ufpb.br"));
            assertEquals("jose@dcx.ufpb.br", sistema.pesquisaAmigoSecreto("maria@dcx.ufpb.br"));
